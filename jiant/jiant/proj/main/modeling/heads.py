...
class MultiLabelSpanClassification(BaseHead):
    def __init__(self, task, hidden_size, hidden_dropout_prob, **kwargs):
        """From RobertaForSpanComparisonClassification"""
        super().__init__()
        self.num_spans = task.num_spans
...
@JiantHeadFactory.register([TaskTypes.SINGLE_LABEL_SPAN_CLASSIFICATION])
class SingleLabelSpanClassification(BaseHead):
    def __init__(self, task, hidden_size, hidden_dropout_prob, **kwargs):
        """From RobertaForSpanComparisonClassification"""
        super().__init__()
        self.num_spans = task.num_spans
