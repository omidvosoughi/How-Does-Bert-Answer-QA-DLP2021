"""Two-span, single-label edge-probing task base class.
This module defines an AbstractProbingTask and inheritable logic for tokenization and featurization.
Two-span, single-label edge-probing tasks should inherit from AbstractProbingTask and the dataclasses
defined here. See sup.py for an example task implementation inheriting from this module.
"""
from abc import ABC
